...
#sons
galinha = pygame.mixer.Sound("CHICKEN.WAV")
cavalo = pygame.mixer.Sound("horse.wav")
vitoria = pygame.mixer.Sound("vitoria.wav")
teste = pygame.mixer.Sound("HOTEL_BE.WAV")
som_passar_mouse = pygame.mixer.Sound("som_carta.wav")

welcome = pygame.mixer.Sound("BemVindoFase1.wav")
